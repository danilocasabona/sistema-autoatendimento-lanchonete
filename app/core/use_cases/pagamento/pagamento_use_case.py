...
class PagamentoUseCase:
    ...
    def listar_todos_pagamentos(self) -> list[PagamentoResponseSchema]: 
        consulta_pagamento: list[Pagamento] = self.pagamento_repository.listar_todos_pagamentos()
    ...
    def deletar_pagamento(self, codigo_pagamento: str): 
        self.pagamento_repository.deletar_pagamento(codigo_pagamento=codigo_pagamento)